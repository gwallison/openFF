...
today_str = '2023-12-19' # used as file name when finalizing and uploading
make_final = True
...
s= "jupyter nbconvert --no-input --ExecutePreprocessor.allow_errors=True --ExecutePreprocessor.timeout=-1 --execute Recent_Disclosures.ipynb --to=html "
print(subprocess.run(s,capture_output=False))
add_favicon(fn='Recent_Disclosures.html')
...
if make_final:
    ...
    if c == 'y':
        ...
        shutil.copyfile('Recent_Disclosures.html',
